# Cisco Firepower 1010 重新映像
---

![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/431075.avif)
...
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/484439.avif)
...
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/430859.avif)
...
## 连接管理电脑 (Linux)
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/接线-1.drawio.svg)
...
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/接线-2.drawio.svg)
...
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/接线-3.drawio.svg)
...
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/接线-4.drawio.svg)
...
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/接线-5.drawio.svg)
...
::: tabs key:英文中文
== 英文
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/479219.avif)
== 中文
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心注册防火墙-1.png)
:::
...
::: tabs key:英文中文
== 英文
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/451335.avif)
== 中文
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心注册防火墙-2.png)
:::
...
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/接线-6.drawio.svg)
...
::: tabs
== 图1 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-1.png)
== 图2 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-2.png)
== 图3
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-3.png)
:::
...
::: tabs
== 图1 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-4.png)
== 图2 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-5.png)
== 图3
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-6.png)
:::
...
::: tabs
== 图1 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-7.png)
== 图2 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-8.png)
== 图3
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-9.png)
:::
...
::: tabs
== 图1 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-10.png)
== 图2 ->
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-11.png)
== 图3
![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/管理中心上配置防火墙接口-12.png)
:::

![图片](__LmgzsDocs_STATIC_ASSET_SERVER__/__CUR_DIR__/images/接线-7.drawio.svg)
